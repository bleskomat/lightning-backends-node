	...
	inputs: [
		{
			name: 'secret',
			label: 'Secret',
			help: 'If using LNBits: Go to Extensions to enable the LndHub extension; then open the LndHub extension page and copy the LndHub Admin URL.',
			type: 'password',
			placeholder: 'lndhub://admin:xxx@https://your-lnbits-instance/lndhub/ext/',
			default: '',
			required: true,
		},
	],
